...
const BirdSalesReport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`/api/viewBirdSales?startDate=${startDate}&endDate=${endDate}`);
      if (!response.ok) {
...
export default BirdSalesReport;
