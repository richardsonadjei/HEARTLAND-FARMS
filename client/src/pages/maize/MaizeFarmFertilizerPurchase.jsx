...
const PurchaseMaizeFertilizer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-maize-fertilizer-purchase', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Maize fertilizer purchase recorded successfully');
      ...
      console.error('Error recording maize fertilizer purchase:', error);

      // Set error message
      setMessage(`Error recording maize fertilizer purchase: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Purchase Maize Fertilizer</h2>
          {message && (
...
export default PurchaseMaizeFertilizer;
