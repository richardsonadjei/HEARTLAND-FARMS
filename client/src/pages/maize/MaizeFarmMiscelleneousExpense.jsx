...
const MaizeFarmMiscellaneousExpense = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-maize-misc-expense', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Maize miscellaneous expenditure recorded successfully');
      ...
      console.error('Error recording maize miscellaneous expenditure:', error);

      // Set error message
      setMessage(`Error recording maize miscellaneous expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Record Maize Miscellaneous Expenditure</h2>
          {message && (
...
export default MaizeFarmMiscellaneousExpense;
