...
const PlantMaize = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/plant-maize', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Maize planting and expenditure recorded successfully');
      ...
      console.error('Error recording maize planting and expenditure:', error);

      // Set error message
      setMessage(`Error recording maize planting and expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Plant Maize</h2>
          {message && (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Row form>
              ...
              <Col md={6}>
                <FormGroup>
                  <Label for="maizeVariety">Maize Variety:</Label>
                  <Input
                    type="text"
                    name="maizeVariety"
                    id="maizeVariety"
            ...
            <Button type="submit">Plant Maize</Button>
          </Form>
        </Col>
      </Row>
    </Container>
