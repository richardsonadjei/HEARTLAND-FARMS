...
const MaizeHarvest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/harvest-maize', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Maize harvest and expenditure recorded successfully');
      ...
      console.error('Error recording maize harvest and expenditure:', error);

      // Set error message
      setMessage(`Error recording maize harvest and expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Maize Harvest</h2>
          {message && (
