...
const MaizeWeedicideApplication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-maize-weedicide-application', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Weedicide application and expenditure recorded successfully');
      ...
      console.error('Error recording weedicide application and expenditure:', error);

      // Set error message
      setMessage(`Error recording weedicide application and expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Weedicide Application</h2>
          {message && (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Button type="submit">Record Weedicide Application</Button>
          </Form>
        </Col>
      </Row>
    </Container>
