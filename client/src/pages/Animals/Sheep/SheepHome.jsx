...
import AllAnimalSalesByTypeReport from './AnimalSalesReport';

const allFarmItems = [
  {
    id: 1,
    title: 'Click To View Sheep Farm Records',
    subItems: [
      { id: 11, title: 'All Sheeps' },
              ...
              {selectedSubItem && selectedSubItem.id === 11 && (
                <div>
                  <button
                    ...
                    onClick={() => handleActionClick('allSheeps')}
                  >
                    All Sheeps
                  </button>
                  {selectedAction === 'allSheeps' && (
                    <div>
                      <AllAnimalsReport/>
                    </div>
                  )}
