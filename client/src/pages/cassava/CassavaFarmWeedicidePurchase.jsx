...
const CassavaFarmWeedicidePurchase = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-cassava-weedicide-purchase', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Cassava weedicide purchase recorded successfully');
      ...
      console.error('Error recording cassava weedicide purchase:', error);

      // Set error message
      setMessage(`Error recording cassava weedicide purchase: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Purchase Cassava Weedicide</h2>
          {message && (
...
export default CassavaFarmWeedicidePurchase;
