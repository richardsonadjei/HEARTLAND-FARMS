...
const CassavaWeedicideApplication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-weedicide-application-and-expense', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Weedicide application recorded successfully');
      ...
      console.error('Error recording weedicide application:', error);

      // Set error message
      setMessage(`Error recording weedicide application: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Cassava Weedicide Application</h2>
          {message && (
