...
const CassavaGettingStarted = () => {
  ...
  const handleStartCassavaClick = async () => {
    try {
      ...
      const response = await fetch('/api/new-cassava-season', {
        method: 'POST',
        headers: {
      ...
      console.error('Error starting cassava activities:', error);
    ...
    <Container fluid className="dashboard-container">
      <Row className="header">
        <Col className="text-center">
          <h1>
            Welcome to The Cassava Farm Dashboard,{' '}
            {currentUser ? (
          ...
          <p>Get Started with Cassava Farming</p>
        </Col>
      </Row>

      <Row className="features">
        <Col md={4} className="feature">
          <Link to="/cassava-farm-activities" className="card-link">
            <FaSeedling className="icon" />
            <h3 className="card-title">Farm Activities</h3>
            <p className="card-description">Record and monitor all your cassava farming activities. Track planting, weeding, and harvesting.</p>
          </Link>
        </Col>
        <Col md={4} className="feature">
          <Link to="/cassava-financial-activities" className="card-link">
            <FaMoneyBill className="icon" />
            <h3 className="card-title">Financial Transactions</h3>
            <p className="card-description">Keep track of all financial transactions related to cassava farming. Record expenses and income.</p>
          </Link>
        </Col>
        <Col md={4} className="feature">
          <Link to="/cassava-farm-report" className="card-link">
      ...
      <Row className="cta">
        <Col className="text-center">
          ...
          <Button variant="success" onClick={handleShowModal}>
            Start New Cassava Season
          </Button>

          {/* New Modal for Recording New Season */}
          <Modal show={showModal} onHide={handleCloseModal}>
            <Modal.Header closeButton>
              <Modal.Title>Record New Cassava Season</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <Form>
            ...
            <Modal.Footer>
              ...
              <Button variant="primary" onClick={handleStartCassavaClick}>
                Start Cassava Season
              </Button>
            </Modal.Footer>
          </Modal>
...
export default CassavaGettingStarted;
