...
const CassavaHarvest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-cassava-harvest-and-expense', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Cassava harvest and expenditure recorded successfully');
      ...
      // Set error message
      setMessage(`Error recording cassava harvest and expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Cassava Harvest</h2>
          {message && (
