...
const CassavaFertilizerApplication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-cassava-fertilizer-application-and-expense', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Fertilizer application and expense recorded successfully');
      ...
      console.error('Error recording fertilizer application and expense:', error);

      // Set error message
      setMessage(`Error recording fertilizer application and expense: ${error.message}`);

      // Clear the error message after a delay (e.g., 3 seconds)
      setTimeout(() => {
        setMessage(null);
        // Refresh the page or handle as needed
      }, 4000);
    }
  };
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Record Fertilizer Application</h2>
          {message && (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Button type="submit">Record Fertilizer Application</Button>
          </Form>
        </Col>
      </Row>
    </Container>
