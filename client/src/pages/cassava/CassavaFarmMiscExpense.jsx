...
const CassavaFarmMiscellaneousExpense = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/record-cassava-misc-expense', {
        method: 'POST',
        headers: {
      ...
      // Set success message
      setMessage('Cassava miscellaneous expenditure recorded successfully');
      ...
      console.error('Error recording cassava miscellaneous expenditure:', error);

      // Set error message
      setMessage(`Error recording cassava miscellaneous expenditure: ${error.message}`);
    ...
    <Container>
      <Row>
        <Col sm="12" md={{ size: 8, offset: 2 }}>
          <h2 className="mb-4 text-center">Record Cassava Miscellaneous Expenditure</h2>
          {message && (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Button type="submit">Record Miscellaneous Expenditure</Button>
          </Form>
        </Col>
      </Row>
    </Container>
...
export default CassavaFarmMiscellaneousExpense;
