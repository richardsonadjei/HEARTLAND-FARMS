...
const  AllGreenPepperFertilizerApplicationRecord = () => {
  ...
  const getAllCabbageFertilizerApplications = async () => {
    try {
      const response = await fetch('/api/all-green-pepper-fertilizer-appication-records');
      if (!response.ok) {
...
export default AllGreenPepperFertilizerApplicationRecord;
