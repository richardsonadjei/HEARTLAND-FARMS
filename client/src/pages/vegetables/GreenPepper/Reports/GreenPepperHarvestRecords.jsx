...
const GreenPepperBatchHarvestingRecords = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/vege-harvesting-records/${batchNumber}`);
      if (!response.ok) {
...
export default GreenPepperBatchHarvestingRecords;
