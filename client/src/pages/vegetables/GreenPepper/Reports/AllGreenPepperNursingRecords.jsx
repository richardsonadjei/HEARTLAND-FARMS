...
const AllGreenPepperNursingRecords = () => {
  ...
  const getAllCabbageNursingRecords = async () => {
    try {
      const response = await fetch('/api/green-pepper-nursing-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Green Pepper Nursing Records</h2>
...
export default AllGreenPepperNursingRecords;
