...
const AllGreenPepperTransplantingReport = () => {
  ...
  const getAllCabbageTransplantingRecords = async () => {
    try {
      const response = await fetch('/api/all-green-pepper-transplanting-records');
      if (!response.ok) {
...
export default AllGreenPepperTransplantingReport;
