...
const AllGreenPepperDirectPlantingReport = () => {
  ...
  const getAllSpringOnionsDirectPlanting = async () => {
    try {
      const response = await fetch('/api/all-green-pepper-direct-planting-records');
      if (!response.ok) {
...
export default AllGreenPepperDirectPlantingReport;
