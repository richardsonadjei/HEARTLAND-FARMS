...
const AllGreenPepperPestAndWeedControlReport = () => {
  ...
  const getAllPestAndWeedControlRecords = async () => {
    try {
      const response = await fetch('/api/all-green-pepper-pest-and-weed-records');
      if (!response.ok) {
...
export default AllGreenPepperPestAndWeedControlReport;
