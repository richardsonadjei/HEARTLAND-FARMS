...
const BatchOtherActivitiesRecords = () => {
  const defaultType = 'Cucumber';
  ...
  return (
    <Container>
      <h2 className="mt-4">Batch Other Activities Records</h2>
...
export default BatchOtherActivitiesRecords;
