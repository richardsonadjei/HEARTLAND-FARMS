...
const AllSpringOnionsNursingRecords = () => {
  ...
  const getAllCabbageNursingRecords = async () => {
    try {
      const response = await fetch('/api/spring-onions-nursing-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Spring Onions Nursing Records</h2>
...
export default AllSpringOnionsNursingRecords;
