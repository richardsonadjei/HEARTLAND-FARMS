...
const  AllSpringOnionsFertilizerApplicationRecord = () => {
  ...
  const getAllCabbageFertilizerApplications = async () => {
    try {
      const response = await fetch('/api/spring-onions-fertilizer-appication-records');
      if (!response.ok) {
...
export default AllSpringOnionsFertilizerApplicationRecord;
