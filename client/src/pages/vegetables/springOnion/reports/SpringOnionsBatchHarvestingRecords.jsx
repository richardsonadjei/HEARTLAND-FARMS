...
const SpringOnionsBatchHarvestingRecords = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/spring-onions-harvesting-records/${batchNumber}`);
      if (!response.ok) {
...
export default SpringOnionsBatchHarvestingRecords;
