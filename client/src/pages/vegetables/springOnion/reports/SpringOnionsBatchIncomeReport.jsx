...
const SpringOnionBatchIncome = () => {
  const defaultType = 'Spring Onions'; // Corrected default type
  ...
  return (
    <Container>
      <h2 className="mt-4">Spring Onion Batch Income</h2>
...
export default SpringOnionBatchIncome;
