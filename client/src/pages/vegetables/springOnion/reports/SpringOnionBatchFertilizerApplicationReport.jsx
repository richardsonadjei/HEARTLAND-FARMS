...
const SpringOnionBatchFertilizerApplication = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/cabbage-fertilizer-applicaion/${batchNumber}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Cabbage Batch Fertilizer Application Report</h2>
...
export default SpringOnionBatchFertilizerApplication;
