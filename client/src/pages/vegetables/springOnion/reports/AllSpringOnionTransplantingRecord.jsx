...
const AllSpringOnionsTransplantingReport = () => {
  ...
  const getAllCabbageTransplantingRecords = async () => {
    try {
      const response = await fetch('/api/all-spring-onions-transplanting-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Spring Onions Transplanting Records</h2>
...
export default AllSpringOnionsTransplantingReport;
