...
const SpringOnionFertilizerApplication = () => {
  ...
  return (
    <Container>
      <h2 className="mt-4">Spring Onions Batch Fertilizer Application Report</h2>
...
export default SpringOnionFertilizerApplication;
