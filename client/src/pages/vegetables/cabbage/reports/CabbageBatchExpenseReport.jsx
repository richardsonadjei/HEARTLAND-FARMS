...
const CabbageBatchExpense = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/cabbage-expense-records/${batchNumber}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Cabbage Batch Expense Report</h2>
...
export default CabbageBatchExpense;
