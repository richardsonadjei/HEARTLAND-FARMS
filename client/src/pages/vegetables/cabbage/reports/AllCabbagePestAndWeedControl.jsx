...
const AllCabbagePestAndWeedControlReport = () => {
  ...
  const getAllPestAndWeedControlRecords = async () => {
    try {
      const response = await fetch('/api/all-cabbage-pest-and-weed-records');
      if (!response.ok) {
...
export default AllCabbagePestAndWeedControlReport;
