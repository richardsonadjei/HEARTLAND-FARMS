...
const AllCabbageFertilizerApplicationRecord = () => {
  ...
  const getAllCabbageFertilizerApplications = async () => {
    try {
      const response = await fetch('/api/cabbage-fertilizer-appication-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Cabbage Fertilizer Application Records</h2>
...
export default AllCabbageFertilizerApplicationRecord;
