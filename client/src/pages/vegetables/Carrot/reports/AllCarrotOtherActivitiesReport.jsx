...
const  AllCarrotOtherActivitiesRecords= () => {
  ...
  const fetchActivitiesRecords = async () => {
    try {
      const response = await fetch('/api/all-carrot-other-activities-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Carrot Other Activities Records</h2>
...
export default AllCarrotOtherActivitiesRecords;
