...
const AllCarrotPestAndWeedControlReport = () => {
  ...
  const getAllPestAndWeedControlRecords = async () => {
    try {
      const response = await fetch('/api/all-carrot-pest-and-weed-records');
      if (!response.ok) {
...
export default AllCarrotPestAndWeedControlReport;
