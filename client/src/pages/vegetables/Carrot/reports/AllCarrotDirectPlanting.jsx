...
const AllCarrotDirectPlantingReport = () => {
  ...
  const getAllSpringOnionsDirectPlanting = async () => {
    try {
      const response = await fetch('/api/all-carrot-direct-planting-records');
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">All Carrot Direct Planting Records</h2>
...
export default AllCarrotDirectPlantingReport;
