...
const GuineaFowlTreatment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/add-guineaFowlTreatments', {
        method: 'POST',
        headers: {
      ...
      setMessage('Bird treatment record has been created successfully!');
      setTimeout(() => {
        window.location.href = '/guinea-fowl-dashboard';
      }, 3000);
    } catch (error) {
      setError('Error creating bird treatment record. Please try again.');
    ...
    <Container className="mt-5">
      <Row>
        <Col md={{ size: 6, offset: 3 }}>
          <h2 className="text-white">Treat Sick Guinea Fowls</h2>
          ...
          <Form onSubmit={handleSubmit} style={{ background: 'rgba(255, 255, 255, 0.8)', padding: '20px', borderRadius: '10px' }}>
            <Row form>
              ...
              <Col md={6}>
                <FormGroup>
                  <Label for="diagnosis" className="text-black">
                    Diagnosis
                  </Label>
                  <Input
                    type="text"
            ...
            <Row form>
              <Col md={12}>
                <FormGroup>
                  <Label className="text-black">Medications</Label>
            ...
            <Row form>
              <Col md={12}>
                <FormGroup>
                  <Label for="notes" className="text-black">
                    Notes
                  </Label>
                  <Input
                    type="textarea"
            ...
            <Row form>
              <Col md={6}>
                <FormGroup>
                  <Label for="treatmentDoneBy" className="text-black">
                    Treatment Done By
                  </Label>
                  <Input
                    type="text"
            ...
            <FormGroup>
              <Input type="submit" color="primary" value="Record-Treatment" />
            </FormGroup>
