...
const SellGuineaFowlEggs = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('/api/sell-guineaFowl-eggs', {
        method: 'POST',
        headers: {
    ...
    <Container>
      <Row>
        <Col>
          ...
          <Form onSubmit={handleSubmit} style={{ background: 'rgba(255, 255, 255, 0.2)', padding: '20px', borderRadius: '10px' }}>
            <Row form>
              <Col md={6}>
                <FormGroup>
...
export default SellGuineaFowlEggs;
