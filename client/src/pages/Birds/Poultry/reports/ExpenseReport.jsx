...
const PoultryExpenseReport = () => {
  ...
  const fetchExpenses = async () => {
    try {
      const response = await fetch(`/api/bird-type-expenses/${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container fluid>
      <h2 className="mt-4">Poultry Expense Report</h2>
...
export default PoultryExpenseReport;
