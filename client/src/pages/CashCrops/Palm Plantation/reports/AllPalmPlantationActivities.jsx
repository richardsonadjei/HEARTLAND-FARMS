...
const PalmAllFarmActivitiesReport = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/all-palm-batch-farm-activities-records/${batchNumber}`);
      if (!response.ok) {
...
export default PalmAllFarmActivitiesReport;
