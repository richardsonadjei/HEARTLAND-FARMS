...
const PlantainBatchHarvestRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/plantain-batch-harvest-records?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Plantain Batch Harvest Record</h2>
...
export default PlantainBatchHarvestRecord;
