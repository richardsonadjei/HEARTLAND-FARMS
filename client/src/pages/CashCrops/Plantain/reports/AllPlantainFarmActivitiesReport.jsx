...
const PlantainAllFarmActivitiesReport = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/all-plantain-batch-farm-activities-records/${batchNumber}`);
      if (!response.ok) {
...
export default PlantainAllFarmActivitiesReport;
