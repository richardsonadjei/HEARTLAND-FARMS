...
const PlantainBatchLandPreparationRecord= () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/plantain-batch-land-preparations?batchNumber=${batchNumber}&cashCrop=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Plantain Batch Land Preparation Record</h2>
...
export default PlantainBatchLandPreparationRecord;
