...
const PlantainBatchPestAndDiseaseControlRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/plantain-batch-pest-disease-controls?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Plantain Batch Pest and Disease Control Record</h2>
...
export default PlantainBatchPestAndDiseaseControlRecord;
