...
const CassavaBatchFertilizerApplicationRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/cassava-batch-fertilizer-application-report?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Cassava Batch Fertilizer Application Record</h2>
...
export default CassavaBatchFertilizerApplicationRecord;
