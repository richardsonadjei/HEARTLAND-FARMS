...
const MaizeBatchPlantingRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/maize-batch-planting?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
...
export default MaizeBatchPlantingRecord;
