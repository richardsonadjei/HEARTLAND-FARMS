...
const MaizeBatchManualWeedingReport = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/maize-batch-manual-weeding?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Maize Batch Manual Weeding Report</h2>
...
export default MaizeBatchManualWeedingReport;
