...
const MaizeAllFarmActivitiesReport = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/all-maize-batch-farm-activities-records/${batchNumber}`);
      if (!response.ok) {
...
export default MaizeAllFarmActivitiesReport;
