...
const MaizeBatchFertilizerApplicationRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/maize-batch-fertilizer-application-report?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Maize Batch Fertilizer Application Record</h2>
...
export default MaizeBatchFertilizerApplicationRecord;
