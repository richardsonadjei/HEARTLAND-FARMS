...
const MaizeBatchPestAndDiseaseControlRecord = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/maize-batch-pest-disease-controls?batchNumber=${batchNumber}&type=${defaultType}`);
      if (!response.ok) {
  ...
  return (
    <Container>
      <h2 className="mt-4">Maize Batch Pest and Disease Control Record</h2>
...
export default MaizeBatchPestAndDiseaseControlRecord;
