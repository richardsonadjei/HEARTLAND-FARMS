...
import { createBirdBatch, getAllBirdBatches, generateAgeReport, getAllBirdBatchesNoDates, getBatchByNumber, updateBatchQuantity, getBatchUpdatesWithinPeriod, addBirdsToBatch, getAdditionsByDateRange, updateCurrentAge, createFeedCategory, getAllFeedCategories, getBatchesBySection } from '../controllers/poultry.controller.js';
...
poultryRouter.get('/batches/:section', getBatchesBySection);
